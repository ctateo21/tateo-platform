# Havo AEO Content — Step 2 & Step 3
### Six pages, ready to implement on havofl.com
Each page includes: meta title, meta description, URL slug, direct answer block, full body content, data table, FAQ section, FAQPage schema (JSON-LD, paste directly into the page's `<head>` or end of `<body>`), and CTA back to the Havo tool.

All Florida-specific figures below are sourced and verified as of 2026 (Florida Dept. of Revenue, FL Statute 201.02, FEMA NFIP). Replace bracketed `[ ]` items with your live data before publishing.

---
---

# PAGE 1 (Step 2) — `/florida-insurance`
### The Florida Insurance Cost Hub — your flagship AEO page

**Meta title:** Florida Homeowners Insurance Cost by Region (2026) | Havo
**Meta description:** See real Florida homeowners insurance costs by region — from 0.54% to 6.65% of rebuild cost. Tampa, Miami, Orlando, the Keys, and more. Free instant estimate, no login.
**URL:** havofl.com/florida-insurance

---

### Direct Answer (place at the very top of the page, before anything else)
...
**Are impact windows worth it for insurance savings?**
...
**How do I get my exact insurance cost, not just a regional estimate?**
...
### FAQPage Schema (paste into page `<head>` or before `</body>`)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Why is homeowners insurance so expensive in Florida?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Florida insurance is priced around hurricane and wind risk, which varies enormously by region. Coastal counties with direct hurricane exposure — Monroe, Miami-Dade, Broward — carry the highest rates in the country. Inland counties away from the coast, like Alachua or Marion, carry rates closer to the national average."
      }
    },
    {
      "@type": "Question",
      "name": "Why is Miami insurance more expensive than Tampa insurance?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Miami-Dade and Broward sit in the Southeast Florida Coastal tier (2.33%-4.07% of rebuild cost) due to direct Atlantic hurricane exposure and dense coastal development. Tampa Bay sits in a Moderate-High tier (1.10%-1.70%) because the Gulf-facing geography and historical storm tracks carry comparatively lower wind risk."
      }
    },
    {
      "@type": "Question",
      "name": "Does a new roof actually lower my insurance?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, significantly. A roof installed in the last 5 years can earn up to a 15% discount versus a roof over 20 years old, which can carry up to a 35% surcharge. Roof age is one of the most heavily weighted factors in Florida underwriting."
      }
    },
    {
      "@type": "Question",
      "name": "Are impact windows worth it for insurance savings?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "In high-wind regions, impact windows and doors can reduce your premium by up to 25%. In Miami-Dade and Broward, any home built after 2002 is required by code to have them, so the discount applies automatically in most cases."
      }
    },
    {
      "@type": "Question",
      "name": "How do I get my exact insurance cost, not just a regional estimate?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Regional estimates are a starting point, not a final number. Havo's free calculator pulls your specific property's construction type, roof year, and flood zone, then runs live quotes from real Florida carriers, no login required."
      }
    }
  ]
}
...
### CTA (end of page)
> **See your exact number, not a regional average.**
> Enter your address and Havo shows your real insurance estimate — construction type, roof year, and flood zone factored in — free, no login.
> [Get My Insurance Estimate →]

---
---

# PAGE 2 (Step 3) — `/florida-homeowners-insurance-cost`
### Mirrors the #1 query Florida buyers type into AI search

**Meta title:** How Much Is Homeowners Insurance in Florida? (2026 Real Numbers)
**Meta description:** Florida homeowners insurance averages $1,800–$13,300/year depending on region. See real numbers by city, what drives the cost, and your exact estimate in 60 seconds.
**URL:** havofl.com/florida-homeowners-insurance-cost
...
**Is Florida the most expensive state for homeowners insurance?**
...
**Why does my insurance quote keep changing as I add property details?**
...
**Can I lower my Florida homeowners insurance?**
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What is the average homeowners insurance cost in Florida?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "There is no single statewide average that's useful, costs range from roughly $1,800/year in inland North-Central Florida to over $13,000/year in the Florida Keys, depending entirely on region."
      }
    },
    {
      "@type": "Question",
      "name": "Is Florida the most expensive state for homeowners insurance?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Florida consistently ranks among the most expensive states, driven by hurricane and flood exposure. However, costs vary so widely within the state itself that an inland Florida home can insure for less than homes in some non-coastal states, while a coastal Florida home can cost multiples more."
      }
    },
    {
      "@type": "Question",
      "name": "Why does my insurance quote keep changing as I add property details?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Florida insurance underwriting is highly sensitive to specific property characteristics, roof year and construction type alone can swing a quote by 30% or more. A true quote requires your property's specific details, not just its zip code."
      }
    },
    {
      "@type": "Question",
      "name": "Can I lower my Florida homeowners insurance?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. The two highest-impact changes are replacing an aging roof and adding impact-rated windows or doors, which combined can reduce premiums by 30-40% on older coastal homes."
      }
    }
  ]
}
...
### CTA
> **Stop guessing with statewide averages.**
> Run your real address through Havo and see what your specific home actually costs to insure — free, instant, no login.
> [Get My Real Number →]

---
---

# PAGE 3 (Step 3) — `/mortgage-payment-calculator-florida`

**Meta title:** Florida Mortgage Payment Calculator — Real PITI, Not Just P&I (2026)
**Meta description:** Most calculators only show principal and interest. See your full Florida mortgage payment — taxes, insurance, and HOA included — in 60 seconds, free, no login.
**URL:** havofl.com/mortgage-payment-calculator-florida

---

### Direct Answer

> **What is my mortgage payment on a house in Florida?**
...
**Does my mortgage payment include taxes and insurance in Florida?**
...
**What's a realistic mortgage payment on a $400,000 home in Florida?**
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Does my mortgage payment include taxes and insurance in Florida?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "If you put down less than 20%, your lender almost always escrows property tax and insurance into your monthly payment automatically. Even with 20%+ down, you're still responsible for both, they just aren't collected monthly by the lender unless you choose to escrow voluntarily."
      }
    },
    {
      "@type": "Question",
      "name": "Why is my estimated payment different from what my lender quoted?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Generic calculators typically use a national average for taxes and insurance rather than your property's actual county millage rate and region-specific insurance cost, which in Florida can be off by hundreds of dollars a month."
      }
    },
    {
      "@type": "Question",
      "name": "What's a realistic mortgage payment on a $400,000 home in Florida?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It depends heavily on location. In inland Central Florida, expect roughly $2,600-$2,900/month all-in. In Tampa Bay, roughly $2,800-$3,200/month. In Miami-Dade or Broward, roughly $3,300-$4,000/month, the difference is almost entirely insurance and tax rate."
      }
    },
    {
      "@type": "Question",
      "name": "Do I need flood insurance in Florida?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Only if your property sits in a FEMA-designated high-risk flood zone (typically zones beginning with A or V) and you have a federally backed mortgage, in that case it's required. Outside those zones it's optional but often still worth carrying given Florida's flood exposure."
      }
    }
  ]
}
...
### CTA
> **See your real PITI, not just principal and interest.**
> Havo calculates your full monthly payment — mortgage, real property tax, and real insurance for your specific property — in one place. Free, no login.
> [Calculate My Real Payment →]

---
---

# PAGE 4 (Step 3) — `/florida-flood-zones-explained`

**Meta title:** Do I Need Flood Insurance in Florida? Flood Zones Explained (2026)
**Meta description:** Flood Zone X doesn't mean no risk — it means no federal requirement. See what every FEMA flood zone means in Florida and whether you actually need coverage.
**URL:** havofl.com/florida-flood-zones-explained
...
Flood zone is one of the most misunderstood factors in a Florida home purchase. Buyers often hear "Zone X" and assume it means no flood risk at all — it actually means no federal flood insurance requirement, which is a different statement entirely.
...
It depends on the property. Private insurers like Neptune Flood often offer higher coverage limits, broader policy terms, and competitive pricing, especially for moderate-risk properties. For the highest-risk coastal zones, NFIP's federally backstopped pricing can sometimes be more favorable. Comparing both is the only way to know for a specific property.

**How much does flood insurance cost in Florida?**
NFIP premiums vary by flood zone, foundation type, and elevation, but commonly range from $400/year in lower-risk zones to $2,000+/year in high-risk coastal VE zones. Private flood quotes vary by carrier and can be lower or higher depending on the specific property.

**Can I find out my flood zone before making an offer?**
Yes. Flood zone is determined by FEMA Flood Insurance Rate Maps and can be looked up by address. Havo automatically resolves the flood zone for any property you search and factors it into your insurance estimate.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "What does Flood Zone X mean?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Zone X means the property sits outside FEMA's designated high-risk flood areas. It does not mean zero flood risk, it means flood insurance is not federally required for a mortgage on that property."
      }
    },
    {
      "@type": "Question",
      "name": "Is private flood insurance better than NFIP?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "It depends on the property. Private insurers often offer higher coverage limits, broader policy terms, and competitive pricing, especially for moderate-risk properties. For the highest-risk coastal zones, NFIP's federally backstopped pricing can sometimes be more favorable."
      }
    },
    {
      "@type": "Question",
      "name": "How much does flood insurance cost in Florida?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "NFIP premiums vary by flood zone, foundation type, and elevation, but commonly range from $400/year in lower-risk zones to $2,000+/year in high-risk coastal VE zones. Private flood quotes vary by carrier."
      }
    },
    {
      "@type": "Question",
      "name": "Can I find out my flood zone before making an offer?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Flood zone is determined by FEMA Flood Insurance Rate Maps and can be looked up by address."
      }
    }
  ]
}
...
### CTA
> **Know your flood zone and your real flood cost before you offer.**
> Havo resolves your property's FEMA flood zone automatically and shows private and NFIP estimates side by side. Free, no login.
> [Check My Flood Risk →]

---
---

# PAGE 5 (Step 3) — `/florida-real-estate-closing-costs`

**Meta title:** Florida Closing Costs Explained — Buyer & Seller (2026 Real Numbers)
**Meta description:** Florida closing costs run 2-5% for buyers and 8-9.5% for sellers. See the real fee-by-fee breakdown — doc stamps, title insurance, intangible tax — with real numbers.
**URL:** havofl.com/florida-real-estate-closing-costs
...
Florida closing costs are structured differently than many other states, and the buyer/seller split surprises a lot of out-of-state buyers. Understanding who customarily pays what — and that it's negotiable in the contract — helps you budget accurately before you write an offer.
...
**Is Miami-Dade closing cost different from the rest of Florida?**
...
**Can a seller refuse to pay closing costs in Florida?**
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Who pays closing costs in Florida, the buyer or seller?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Both parties pay closing costs, but the split differs. Florida custom has sellers paying the deed documentary stamp tax, owner's title insurance, and commissions, while buyers pay the mortgage-related taxes, lender fees, and the lender's title policy. The actual split is set by the purchase contract."
      }
    },
    {
      "@type": "Question",
      "name": "How much are closing costs on a $400,000 house in Florida?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Buyer costs typically run $8,000-$20,000 (2-5%). Seller costs typically run $32,000-$38,000 (8-9.5%), driven mainly by the documentary stamp tax, title insurance, and commission."
      }
    },
    {
      "@type": "Question",
      "name": "Is Miami-Dade closing cost different from the rest of Florida?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes. Miami-Dade charges a different documentary stamp rate ($0.60 per $100 plus a $0.45 surtax, for an effective $1.15 per $100) versus the standard $0.70 per $100 used in the other 66 Florida counties."
      }
    },
    {
      "@type": "Question",
      "name": "Can a seller refuse to pay closing costs in Florida?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "The contract determines the split, and either party can negotiate. A seller is not obligated by law to pay any specific cost, Florida custom is just the typical starting point for negotiation."
      }
    }
  ]
}
...
### CTA
> **See your full cash-to-close number, not just the down payment.**
> Havo calculates your real closing costs alongside your mortgage payment and insurance — the complete picture before you offer. Free, no login.
> [Calculate My Closing Costs →]

---
---

# PAGE 6 (Step 3) — `/florida-property-tax-calculator`

**Meta title:** Florida Property Tax Calculator — Homestead & Save Our Homes Explained
**Meta description:** Florida property tax averages 0.8-1.5% of home value, but homestead exemption and the Save Our Homes cap change the math. See real numbers and what a new buyer actually pays.
**URL:** havofl.com/florida-property-tax-calculator
...
Property tax is the part of a Florida home purchase that most often gets estimated wrong, because the number a current owner pays and the number a new buyer will pay can be dramatically different on the exact same property — and most online estimates don't account for that gap.
...
**Will my property tax be the same as the current owner's?**
...
**Do I need to apply for homestead exemption or is it automatic?**
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Will my property tax be the same as the current owner's?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. In most cases the property reassesses to full market value the year after you buy it, meaning your tax bill is typically higher than the current taxes shown on the listing, especially if the seller held the home for many years."
      }
    },
    {
      "@type": "Question",
      "name": "How much does homestead exemption save in Florida?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "On average, roughly $400-$550 per year, based on a typical effective tax rate applied to the $50,000 exemption. Savings are higher in counties with higher millage rates."
      }
    },
    {
      "@type": "Question",
      "name": "What is the Save Our Homes cap?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "A Florida constitutional protection that limits how much a homesteaded property's assessed value can increase each year, capped at 3% or the change in CPI, whichever is lower (2.7% for 2026). It only applies once you have homestead exemption, and it resets to full market value when the property sells to a new owner."
      }
    },
    {
      "@type": "Question",
      "name": "Can I transfer my Save Our Homes savings to a new home?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yes, this is called portability. If you sell a homesteaded Florida property and buy another within roughly 2-3 years, you can transfer up to $500,000 of accumulated Save Our Homes savings to the new homestead."
      }
    },
    {
      "@type": "Question",
      "name": "Do I need to apply for homestead exemption or is it automatic?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You must apply with your county property appraiser by March 1 of the tax year. It is not automatic, missing the deadline means waiting until the following year."
      }
    }
  ]
}
...
### CTA
> **See your real first-year tax bill, not the seller's capped number.**
> Havo factors in reassessment and homestead exemption to show what you'll actually pay — alongside your mortgage and insurance. Free, no login.
...
1. Each page above should become its own route (e.g. `/florida-insurance`, `/florida-homeowners-insurance-cost`, etc.) — likely new static/marketing pages outside your main app shell, since these are SEO/AEO landing pages, not authenticated tool pages.
2. Place the **Direct Answer** block as the literal first text on the page, before any hero image or navigation clutter — AI crawlers and Google AI Overviews weight the first 40-60 words heavily.
3. Paste each **FAQPage schema** block into that page's `<head>` (or just before `</body>`) exactly as written — validate with Google's Rich Results Test before publishing.
4. Every CTA links back into your actual Havo tool (`/select-service` or directly to `/estimate`, `/insurance`, etc.) — that's the conversion point.
5. Internally link all six pages to each other (e.g. the insurance hub page should link to the flood zone page and the mortgage payment page) — topical clustering helps both SEO and AEO.
6. Add `Article` schema in addition to `FAQPage` schema on the insurance hub page (Page 1) since it's your most comprehensive piece — this is the page most likely to get cited as a primary source.
7. Once live, run each page's URL through the HubSpot AEO Grader and Google's Rich Results Test to confirm both citation-readiness and schema validity.
