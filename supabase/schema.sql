...
-- ----------------------------------------------------------------------------
-- 8. hcpa_tax_cache  (Hillsborough parcel rates; 60-day TTL in app code)
-- ----------------------------------------------------------------------------
-- Shared server-side cache. Rates are parcel-specific but price/homestead are
-- not cached; each request recalculates tax from its current scenario inputs.
...
-- Existing deployments already have this cache table without folio.
...
-- ----------------------------------------------------------------------------
-- 9. property_tax_cache  (general multi-county purchase-estimate cache)
-- ----------------------------------------------------------------------------
